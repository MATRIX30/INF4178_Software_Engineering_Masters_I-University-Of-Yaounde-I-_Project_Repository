...
M[0][0]=1
M[1][0]=5"""
M = np.array([[1, 5, 4, 7], [1/5, 1, 2, 3],
             [2, 1/2, 1, 3], [1/7, 1/3, 1/3, 1]])
S = M.sum(axis=0)

N = np.array([[1, 5, 4, 7], [1/5, 1, 2, 3],
             [1/4, 1/2, 1, 3], [1/7, 1/3, 1/3, 1]])
...
def ahp():
    ...
    print(crime)
    table.pop(table[i])
    return {"nom du crime": name[ind], 'numero': ind+1, 'crime_place': name[ind+1]}
